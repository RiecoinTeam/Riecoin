...
export PACKAGES="valgrind clang-16 llvm-16 libclang-rt-16-dev python3-zmq libevent-dev libboost-dev libgmp-dev libminiupnpc-dev libnatpmp-dev libzmq3-dev libsqlite3-dev"
...
export GOAL="install"
export BITCOIN_CONFIG="--enable-zmq --with-gui=no CC=clang-16 CXX=clang++-16" # TODO enable GUI
